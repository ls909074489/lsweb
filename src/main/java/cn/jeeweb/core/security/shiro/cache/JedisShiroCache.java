...
//        byte[] byteKey = SerializeUtil.serialize(buildCacheKey(key));
    	byte[] byteKey = SerializeUtil.toByteKey(buildCacheKey(key));
...
//        return (V) SerializeUtil.deserialize(byteValue);
        return (V) SerializeUtil.toObject(byteValue);
    }
...
//            jedisManager.saveValueByKey(DB_INDEX, SerializeUtil.serialize(buildCacheKey(key)),SerializeUtil.serialize(value), -1);
        	jedisManager.saveValueByKey(DB_INDEX, SerializeUtil.toByteKey(buildCacheKey(key)),SerializeUtil.toByteArray(value), -1);
        } catch (Exception e) {
...
//            jedisManager.deleteByKey(DB_INDEX, SerializeUtil.serialize(buildCacheKey(key)));
            jedisManager.deleteByKey(DB_INDEX, SerializeUtil.toByteKey(buildCacheKey(key)));
        } catch (Exception e) {
