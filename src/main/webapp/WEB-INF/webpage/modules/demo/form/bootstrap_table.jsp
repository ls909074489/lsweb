...
<body class="gray-bg">
	<div class="">
		...
		<div role="form" class="yy-searchbar form-inline">
			<form id="yy-form-query">
				<div class="">
					...
					<input type="text" autocomplete="on" name="query.phone||like" id="query.phone||like" class="form-control input-sm" value="">
					
					<label for="search_LIKE_senddata" class="control-label">发送数据 </label>
					<input type="text" autocomplete="on" name="search_LIKE_senddata" id="search_LIKE_senddata" class="form-control input-sm">
	  ...
	  <!-- 自定义js --> 
	  <script src="${staticPath}/common/yy/yy-ui-utils.js?v=34"></script> 
	  <script>
	  ...
	  var _tableCols= [
		  ...
		  $(document).ready(function() {
			...
			function onAdd() {
				...
				openlsDialog("添加","${serviceurl}/create","ls-table","90%", "90%");
				onAddAfter();
			}
			...
			function onEdit(){
				...
				openlsDialog("修改","${serviceurl}/onEdit?id="+pks.toString(),"ls-table","90%", "90%");
			}
